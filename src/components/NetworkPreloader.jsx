  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center justify-center select-none">
        ...
        {/* SVG Rings + Orbiting Dots using Uiverse Animation */}
        <div ref={ringsRef} className="relative w-[360px] h-[360px] md:w-[420px] md:h-[420px] flex items-center justify-center">
          ...
          {/* Central Content Inside Rings (percentage + SH badge) */}
          <div className="absolute inset-0 flex flex-col items-center justify-center z-20 pointer-events-none">
            {/* Pulsing glyph */}
            <div
              ref={heroGlyphRef}
              className="w-14 h-14 rounded-2xl bg-gradient-to-br from-cyan-400/20 to-fuchsia-500/20 border border-white/10 flex items-center justify-center mb-3 backdrop-blur-sm"
            >
              <span className="font-syne font-black text-xl text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-fuchsia-500">
                SH
              </span>
            </div>

            {/* Progress percentage */}
            <div className="font-syne text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-fuchsia-500 tabular-nums tracking-tight">
